        ...
        <main class="flex-grow flex flex-col bg-white">
            <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex-shrink-0 my-auto py-16 sm:py-32">
                    <p class="text-sm font-semibold text-indigo-600 uppercase tracking-wide">Você foi Banido</p>
                    ...
                    <div class="mt-6">
                        <a href="{{ route('home') }}" class="text-base font-medium text-indigo-600 hover:text-indigo-500">Go back
